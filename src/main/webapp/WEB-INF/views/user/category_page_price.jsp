		...
		<div id="column-left" class="col-sm-4 col-lg-3 ">
			...
			<div class="filter left-sidebar-widget mb_50">
				...
				<div class="filter-block">
					<form action="/user/fillter" method="post">
					<label for="amount">Brand:</label>
						<select class="form-control" name="field1">
							<option  value="1000"><a >Rolex Watches</a></option>
							<option value="1001"> <a>hãng 1</a> </option>
							<option value="1002"><a>hãng 2</a></option>
						</select>
						<br>
							<p>
								<label for="amount">Price range:</label> <input type="text"
									id="minamount" name="min"> <input type="text"
									id="maxamount" name="max">
								...
								<div class="product-thumb">
									<div class="image product-imageblock">
										<a href="product_detail_page"> <img class="img-responsive"
											...
											src="/forUser/images/product/product1.jpg"> <img
											class="img-responsive" title="iPod Classic"
											alt="iPod Classic"
											src="/forUser/images/product/product1-1.jpg">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="product-list col-xs-4">
								<div class="product-thumb">
									<div class="image product-imageblock">
										<a href="product_detail_page"> <img class="img-responsive"
											title="iPod Classic" alt="iPod Classic"
											src="/forUser/images/product/product7.jpg"> <img
											class="img-responsive" title="iPod Classic"
											alt="iPod Classic"
											src="/forUser/images/product/product7-1.jpg">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="product-list col-xs-4">
								<div class="product-thumb">
									<div class="image product-imageblock">
										<a href="product_detail_page"> <img class="img-responsive"
											title="iPod Classic" alt="iPod Classic"
											src="/forUser/images/product/product10.jpg"> <img
											class="img-responsive" title="iPod Classic"
											alt="iPod Classic"
											src="/forUser/images/product/product10-1.jpg">
										</a>
									</div>
								</div>
							</div>
							...
							<div class="product-list col-xs-4">
								<div class="product-thumb">
									<div class="image product-imageblock">
										<a href="product_detail_page"> <img class="img-responsive"
											title="iPod Classic" alt="iPod Classic"
											src="/forUser/images/product/product3.jpg"> <img
											class="img-responsive" title="iPod Classic"
											alt="iPod Classic"
											src="/forUser/images/product/product3-1.jpg">
										</a>
									</div>
								</div>
							</div>
				...
				<div class="sort-wrapper pull-right">
					...
					<form action="/user/brand" method="post">
						<select id="input-sort" class="form-control" name="field1">
							...
							<option  value="1000"><a href="/user/brand?field1=1000">Rolex Watches</a></option>
