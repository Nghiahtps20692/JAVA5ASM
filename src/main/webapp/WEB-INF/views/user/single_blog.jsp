              ...
              <div class="row ">
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                    <div class="thumb post-img"><a href="#"> <img src="/forUser/images/blog/blog_img_01.jpg"  alt="themini"></a></div>
                  </div>
                ...
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                    <div class="thumb post-img"><a href="#"> <img src="/forUser/images/blog/blog_img_02.jpg"  alt="themini"></a></div>
                  </div>
                  <div class="post-info col-xs-8 ">
                    <h5> <a href="single_blog">Fashions fade, style is eternal</a> </h5>
                    <div class="date pull-left"> <i class="fa fa-calendar" aria-hidden="true"></i>11 May 2017 </div>
                ...
                <div class="blog-item mb_20">
                  <div class="post-format col-xs-4">
                    <div class="thumb post-img"><a href="#"> <img src="/forUser/images/blog/blog_img_03.jpg"  alt="themini"></a></div>
                  </div>
                  <div class="post-info col-xs-8 ">
                    <h5> <a href="single_blog">Fashions fade, style is eternal</a> </h5>
                    <div class="date pull-left"> <i class="fa fa-calendar" aria-hidden="true"></i>11 May 2017 </div>
          ...
          <div class="row">
            <div class="blog-item listing-effect col-md-12 mb_50">
              <div class="post-format">
                <div class="thumb post-img"><a href="/forUser/images/blog/blog_img_01.jpg" title="Beautiful Lady"> <img src="/forUser/images/blog/blog_img_01.jpg"  alt="themini"></a></div>
                <div class="post-type"> <i class="fa fa-picture-o" aria-hidden="true"></i> </div>
              </div>
              <div class="post-info mtb_20 ">
                <h2 class="mb_10"> <a href="single_blog">Fashions fade, style is eternal</a> </h2>
              ...
              <div class="author-about mt_50">
                ...
                <div class="author mtb_30">
                  <div class="author-avatar"> <img alt="" src="/forUser/images/user1.jpg"></div>
                ...
                <ul class="comment-list mt_30">
                  <li class="comment">
                    ...
                    <article class="comment-body mtb_20">
                      <div class="comment-avatar"> <img alt="" src="/forUser/images/user2.jpg"> </div>
                    ...
                    <ol class="children">
                      <li class="comment">
                        <article class="comment-body mtb_20">
                          <div class="comment-avatar"> <img alt="" src="/forUser/images/user3.jpg"> </div>
                          <div class="comment-main">
                  ...
                  <li class="comment">
                    <hr>
                    <article class="comment-body mtb_20">
                      <div class="comment-avatar"> <img alt="" src="/forUser/images/user1.jpg"> </div>
                      <div class="comment-main">
